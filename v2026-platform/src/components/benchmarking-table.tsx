...
export function BenchmarkingTable() {
    return (
        <section className="py-24 relative" id="benchmarking">
            {/* Glassmorphic Background for Section Separation */}
            <div className="absolute inset-0 bg-white/5 backdrop-blur-sm border-t border-b border-white/5"></div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-5xl mx-auto card bg-gray-950/50 backdrop-blur-md border border-gray-800 rounded-3xl overflow-hidden shadow-2xl">
