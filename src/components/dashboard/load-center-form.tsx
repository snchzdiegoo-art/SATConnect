        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section className="border rounded-lg p-6 bg-white">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <Label htmlFor="bokun_id" className="text-gray-700">Bókun ID (optional)</Label>
                        <Input
                            id="bokun_id"
                            type="number"
            ...
            <section className="border rounded-lg p-6 bg-green-50">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">👥 Shared Rates</h3>
                <div className="grid grid-cols-3 gap-4">
                    <div>
                        <Label htmlFor="net_rate_adult" className="text-gray-700">Net Rate Adult * (USD)</Label>
                        <Input
                            id="net_rate_adult"
                            type="number"
                            step="0.01"
                    ...
                    <div>
                        <Label htmlFor="shared_factor" className="text-gray-700">Shared Factor * (1.0-2.0)</Label>
                        <Input
                            id="shared_factor"
                            type="number"
                            step="0.01"
                    ...
                    <div>
                        <Label htmlFor="shared_min_pax" className="text-gray-700">Min Pax (Shared)</Label>
                        <Input
                            id="shared_min_pax"
                            type="number"
                    ...
                    <div>
                        <Label htmlFor="net_rate_child" className="text-gray-700">Net Rate Child (USD)</Label>
                        <Input
                            id="net_rate_child"
                            type="number"
                            step="0.01"
                    ...
                    <div>
                        <Label htmlFor="infant_age_threshold" className="text-gray-700">Free Infant Age (years)</Label>
                        <Input
            ...
            <section className="border rounded-lg p-6 bg-blue-50">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">🚗 Private Rates</h3>
                <div className="grid grid-cols-3 gap-4">
                    <div>
                        <Label htmlFor="private_min_pax_net_rate" className="text-gray-700">Private Net Rate (USD)</Label>
                        <Input
                    ...
                    <div>
                        <Label htmlFor="private_factor" className="text-gray-700">Private Factor (1.0-2.0)</Label>
                        <Input
                            id="private_factor"
                            type="number"
                            step="0.01"
                    ...
                    <div>
                        <Label htmlFor="private_min_pax" className="text-gray-700">Min Pax (Private)</Label>
                        <Input
                            id="private_min_pax"
                            type="number"
            ...
            <section className="border rounded-lg p-6 bg-yellow-50">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">⚙️ Operations</h3>
                <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <Label htmlFor="days_of_operation" className="text-gray-700">Days of Operation</Label>
                        <Input
                    ...
                    <div>
                        <Label htmlFor="cxl_policy" className="text-gray-700">Cancellation Policy</Label>
                        <Input
                            id="cxl_policy"
                    ...
                    <div>
                        <Label htmlFor="extra_fees" className="text-gray-700">Extra Fees</Label>
                        <Input
                            id="extra_fees"
                    ...
                    <div className="col-span-2">
                        <Label htmlFor="meeting_point_info" className="text-gray-700">Meeting Point / Pickup Info</Label>
                        <Textarea
            ...
            <section className="border rounded-lg p-6 bg-purple-50">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">📸 Content & Links</h3>
                <div className="grid grid-cols-1 gap-4">
                    <div>
                        <Label htmlFor="pictures_url" className="text-gray-700">Pictures Link</Label>
                        <Input
                            id="pictures_url"
                            type="url"
                    ...
                    <div>
                        <Label htmlFor="landing_page_url" className="text-gray-700">Landing Page URL</Label>
                        <Input
                            id="landing_page_url"
                            type="url"
                    ...
                    <div>
                        <Label htmlFor="storytelling_url" className="text-gray-700">Storytelling Link</Label>
                        <Input
                            id="storytelling_url"
                            type="url"
